...
%>
<!-- boardList는 request 메모리영역에 있지만  페이지 관련 정보는 Servelet(java)메모리 영역에 있기 때문에 표현식을 이용해서 가져와야 한다.-->
			...
			<c:forEach var="board" items="${boardList}">
				<tr>
					...
					<td>
						...
						<span class="badge badge-danger ml-sm-3">${board.getBoard_readcount()}</span> <!-- 조회수 -->
					</td>
