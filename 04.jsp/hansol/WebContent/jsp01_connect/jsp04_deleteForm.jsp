	...
	<div class="container" align="center">
		...
		<form action="jsp04_deleteMember.jsp" method="post">
			<table class="table table-bordered table-dark table-hover">
				...
				<tr>
					<td>작성일</td>
					<td><input type="text" name="crtdate" class="form-control" value="<%= crtdate %>" disabled></td>
				</tr>	
				<tr>
					<td>조회수</td>
					<td><input type="text" name="readcnt" class="form-control" value="<%= readcnt %>" disabled></td>
				</tr>	
				<tr>
					<td>콘텐츠</td>
			...
			<a href="jsp05_listMember.jsp" class="btn btn-primary mt-sm-2">글목록</a>
		</form>
	</div>
</body>
</html>
