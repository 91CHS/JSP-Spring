...
<!-- 
	...
	웹애플리케이션 이름 / root(jsp01_basic/WebContent) -> http://loaclhost:8080/jsp01_basic
		...
		4. WEB_INF/사용자폴더 : css,js,jsp,html등 사용자가 작성하는 파일이 위치하는 폴더

	A. 컨텍스트경로
	
	    request객체에서 컨텍스트의 기본경로는 request.getContexPath()메서드로 확인할 수 있다.
	...
	B. 웹애플리케이션의 배포(deploy)
		...
		b. war파일 형식으로 압축해서 배포하는 방법
		   ...
		   ...실행방법 c:\>jar.eve cvf jsp01_basic.war *
